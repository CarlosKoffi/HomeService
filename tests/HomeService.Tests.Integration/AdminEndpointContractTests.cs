...
public sealed class AdminEndpointContractTests
{
    ...
    [InlineData("GET", "/api/admin/payment-providers", AdminModuleKey.Payments, AdminPermissionAction.View)]
    [InlineData("POST", "/api/admin/payment-providers", AdminModuleKey.Payments, AdminPermissionAction.Create)]
    [InlineData("PUT", "/api/admin/payment-providers/11111111-1111-1111-1111-111111111111", AdminModuleKey.Payments, AdminPermissionAction.Edit)]
