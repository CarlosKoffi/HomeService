...
public sealed class BusinessClientDocumentConfiguration : IEntityTypeConfiguration<BusinessClientDocument>
{
    public void Configure(EntityTypeBuilder<BusinessClientDocument> builder)
    {
        ...
        builder.HasIndex(document => new { document.BusinessClientProfileId, document.DocumentType });
    }
}
