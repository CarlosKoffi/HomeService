...
text_seed AS (
    ...
    FROM (
        VALUES
            ...
            ('HeroStandard', 'subtitle', 'LongText', 'Kaza connecte les clients aux entreprises de services a domicile verifiees. Vous gardez le controle de vos equipes, de vos demandes et de vos interventions.'),
            ...
            ('HeroStandard', 'image.alt', 'ShortText', 'Equipe Kaza en intervention chez un client'),
            ...
            ('TrustedLogos', 'headline', 'ShortText', 'Ils font confiance a Kaza'),
            ...
            ('ContactForm', 'subtitle', 'LongText', 'Laissez vos coordonnees. Nous vous rappelons pour voir comment Kaza peut aider votre entreprise.'),
            ('FooterLinks', 'brandText', 'LongText', 'La plateforme B2B pour connecter clients, entreprises et professionnels de confiance.'),
            ('FooterLinks', 'copyright', 'ShortText', '© 2026 Kaza Technologies. Tous droits reserves.'),
...
json_seed AS (
    ...
    FROM (
        VALUES
            ...
            ('FaqAccordion', 'questions', '[{"question":"Comment sont verifiees les entreprises sur Kaza ?","answer":"Nous verifions les informations de l''entreprise, les documents essentiels et le contact responsable avant l''activation complete."},{"question":"L''inscription est-elle gratuite ?","answer":"Oui. L''inscription est gratuite. Kaza applique ensuite une commission uniquement sur les missions realisees."},{"question":"Puis-je refuser une demande client ?","answer":"Oui. Votre entreprise reste libre d''accepter les demandes qui correspondent a son equipe, sa zone et ses disponibilites."},{"question":"Qui choisit le prestataire ?","answer":"Vous pouvez affecter vous-meme un prestataire depuis le portail ou laisser Kaza vous accompagner selon le mode choisi."},{"question":"Comment sont suivis les paiements ?","answer":"Le portail permet de suivre les paiements Mobile Money, les encaissements terrain et les commissions."},{"question":"Combien de temps prend la validation ?","answer":"Elle depend de la qualite du dossier. Plus les informations sont claires, plus la validation est rapide."}]'),
