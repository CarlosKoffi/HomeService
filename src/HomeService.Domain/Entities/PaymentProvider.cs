...
public sealed class PaymentProvider : AuditableEntity
{
    ...
    public PaymentProvider(string code, string name, PaymentMethod method, string? logoUrl, int sortOrder)
    {
        Update(code, name, method, logoUrl, sortOrder);
        IsActive = true;
    }
    ...
    public void Update(string code, string name, PaymentMethod method, string? logoUrl, int sortOrder)
    {
